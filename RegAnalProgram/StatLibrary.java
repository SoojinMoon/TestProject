...
public class StatLibrary {
	...
	double LARGE = 1.7e300;

	
	public double stdnormal_pdf( double z )
	{
	/*
	...
	*/
	...
	public double stdnormal_cdf( double z ) {
	/*
	...
	*/
		...
		double cutoff, root2pi;
		double zabs, prob;
		double temp, expntl, pdf;
	...
	public double stdnormal_inv( double P, int info ) {
	/*
	...
	*/
		double ZERO, ONE, HALF, SPLIT1, SPLIT2, CONST1,	CONST2, 
...
//		HASH SUM EF    47.52583 31754 92896 71629
	...
	public double t_pdf( double x, double v, int info )
	{
	/*
	...
	*/
	...
	public double t_cdf( double x, double v, int info ) {
	/*
	...
	*/
	...
	public double lnbeta( double a, double b, int info )
	{
	/*
	...
	*/
	...
	public double incomp_beta( double x, double a, double b, double beta, int info ) 	{
	/*
	...
	*/
	...
	//  define accuracy and initialise
		...
		boolean indx, b4=true;
		double zero, one, acu, inbeta, psq, cx, xx, pp, qq, term, temp=1, ai, rx;
	    int ns;
	...
	public double lngamma( double z, int info ) {
	/*
	...
	*/
		...
		int j;
		double lnsqrt2pi, dtemp, tmp;
		double a[]={0.0, 0.9999999999995183, 676.5203681218835, -1259.139216722289, 771.3234287757674, -176.6150291498386, 12.50734324009056, -0.1385710331296526, 0.9934937113930748e-5, 0.1659470187408462e-6 };
	...
	public double t_inv( double p, double v, int info ) {
	/*
	...
	*/
	...
	public double beta_pdf( double x, double a, double b, int info )
	{
	/*
	...
	*/
	...
	public double beta_inv( double alpha, double a, double b, double beta, int info ) {
	/*
	...
	*/
	      boolean indx;
	      int iex;
	      double pp, qq, r, fpu, acu, sae, zero, one, two, three, four, five, six;
		  double d, g, s, t, h, w, y, yprev, sq, xin, tx, adj, prev, xinbeta;
	      double temp;
	/*
	     Define accuracy and initialise.
	...
	*/
	...
	public double cauchy_pdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double cauchy_cdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double cauchy_inv( double p, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double chisq_pdf( double x, double df, int info )
	{
	/* 
	...
	*/
	...
	public double chisq_cdf( double x, double df, int info ) {
	/* 
	...
	*/
	...
	public double incomp_gamma( double x, double p, int info ) {
	/*
	...
	*/
	    ...
	    double  xbig, darg, c, rn, a, b, one, zero, gammad;
	    double  an, two, elimit, plimit, three, nine;
	    double  temp;
	...
	public double chisq_inv( double p, double v, int info )
	{
	/* 
	...
	*/
		int j, maxit = 20;
		double g;
		double chi, aa, e, zero, half, one, two, three, six, pmin, pmax, 
	...
	public double exponential_pdf( double x, double a, int info )
	{
	/* 
	...
	*/
	...
	public double exponential_cdf( double x, double a, int info )
	{
	/* 
	...
	*/
	...
	public double exponential_inv( double p, double a, int info )
	{
	/* 
	...
	*/
	...
	public double f_pdf( double x, double df1, double df2, int info )
	{
	/* 
	...
	*/
	...
	public double f_cdf( double x, double df1, double df2, int info ) 	{
	/* 
	...
	*/
	...
	public double f_inv( double p, double df1, double df2, int info ) {
	/* 
	...
	*/
	...
	public double gamma_pdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double gamma_cdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double gamma_inv( double p, double a, double b, int info )
	{
	/* 
	    - percentile of a Gamma distribution Gamma(x; a, b)
	
		- External function required : chisq_inv( double p, double df, int info )
	...
	*/
	...
	public double laplace_pdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double laplace_cdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double laplace_inv( double p, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double logistic_pdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double logistic_cdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double logistic_inv( double p, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double lognormal_pdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double lognormal_cdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double lognormal_inv( double p, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double pareto_pdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double pareto_cdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double pareto_inv( double p, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double uniformc_pdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double uniformc_cdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double uniformc_inv( double p, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double weibull_pdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double weibull_cdf( double x, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double weibull_inv( double p, double a, double b, int info )
	{
	/* 
	...
	*/
	...
	public double binomial_pdf( int x, int n, double p, int info )
	{
	/* 
	...
	*/
	    ...
	    if( x == 0 ) {
	        pval = Math.exp( (double)n * Math.log(1.0-p) );
		}
	    else if( x == n ) {
	        pval = Math.exp( (double)n * Math.log(p) );
		}
	    else {
	        temp1 = 0.0; temp2 = 0.0;
	        for(i=1; i<=x; i++) {
				temp1 += Math.log( (double)(n+1-i) );
	            temp2 += Math.log( (double)(i) );
			}
	        pval = temp1 - temp2 + (double)x * Math.log(p) + (double)(n-x) * Math.log(1.0-p);
	        pval = Math.exp(pval);
		}
	...
	public double binomial_cdf( int x, int n, double p, int info )
	{
	/* 
	...
	*/
	    ...
	    if( x == 0 ) {
	        if( p >= 1.0 ) cumval = 0.0;
	        else cumval = Math.exp( (double)n * Math.log(1.0-p) );
		}
	    else if( x == n ) {
	        cumval = 1.0;
		}
	...
	//
	            if( x <= mode ) {
					for(k=x-1; k>=0; k--) {
						pval *= (1.0-p) / p * (double)(k+1) / (double)(n-k);
	                    cumval += pval;
					}
				}
	            else {
					...
					pval = temp;
					for(k=mode+1; k<=x; k++) {
						pval *= p / (1.0-p)  * (double)(n-k+1) / (double)(k);
						cumval += pval;
					}
				} 
			}
	...
	public double poisson_pdf( int x, double m, int info )
	{
	/* 
	...
	*/
	...
	public double poisson_cdf( int x, double m, int info )
	{
	/* 
	...
	*/
	...
	public double geometric_pdf( int x, double p, int info )
	{
	/* 
	...
	*/
	    ...
	    if( x == 1 ) {
	        ...
	        temp = Math.log(p) + ((double)(x-1)) * Math.log(1.0-p); 
			pval = Math.exp(temp);
		}
	...
	public double geometric_cdf( int x, double p, int info )
	{
	/* 
	...
	*/
		...
		cdf = 1.0 - Math.pow( 1.0-p, (double)x );
	
	    return cdf;
	}

	public double hypergeo_pdf( int x, int n, int M, int N, int info )
	{
	/* 
	...
	*/
	...
	public double chyper( int POINT, int KK, int LL, int MM, int NN, int IFAULT ) {
	/*
	...
	*/
	    int K, L, M, N, I, J, NL, KL, MNKL, MVBIG, MBIG;
	    int itemp, itemp2, info=0;
	    double CHYPER, ZERO, ONE, P, PT;
		double HALF, ELIMIT;
		double dMEAN;
		double SIG, SXTEEN;
		double SCALE, ROOTPI, ARG, HUNDRD;
		double temp;
	    boolean DIR;
	...
	//     CHECK ARGUMENTS ARE WITHIN PERMITTED LIMITS
	    ...
	    if( (double)itemp > (SXTEEN * temp) && MM > MVBIG && ELIMIT > -HUNDRD ) 
		{
	//     USE A NORMAL APPROXIMATION
	
			dMEAN = (double)(KK) * (double)(NN) / (double)(MM);
			SIG = Math.sqrt( dMEAN * ( (double)(MM-NN) / (double)(MM) ) * ( (double)(MM-KK) /
	                    (double)(MM-1) ) );
	        if(POINT==1)
			{
				ARG = -HALF * (( (double)(LL) - dMEAN ) / SIG) * (( (double)(LL) - dMEAN ) / SIG);
	            CHYPER = ZERO;
				if(ARG >= ELIMIT) CHYPER = Math.exp(ARG) / (SIG * ROOTPI);
			}
			else
			{
				CHYPER = stdnormal_cdf( ( (double)(LL) + HALF - dMEAN ) / SIG );
			}
		}
		else
		{
	...
	//          TAKE LOGARITHMS OF FACTORIALS.
				...
				P = lngamma((double)NN, info) - lngamma((double)MM, info) + 
					lngamma((double)(MM-KK), info) + lngamma((double)KK, info) +
	                lngamma((double)(MM-NN), info) - lngamma((double)LL, info) -  
					lngamma((double)(NN-LL), info) - lngamma((double)(KK-LL), info) -
	                lngamma((double)(MM-NN-KK+LL), info);
				CHYPER = ZERO;
	...
	//          USE FREEMAN/LUND ALGORITHM
				...
				for(I=1; I<=L-1; I++)
					CHYPER = CHYPER * (double)(K-I) * (double)(N-I) / ( (double)(L-I) *
	                           (double)(M-I) );
				if(L != K) 
				{
					J = M - N + L;
					for(I=L; I<=K-1; I++)
						CHYPER = CHYPER * (double)(J-I) / (double)(M-I);
				}
			}
	...
	//          WE MUST RECOMPUTE THE POINT PROBABILITY SINCE IT HAS UNDERFLOWED.
				...
				if(MM <= MBIG)
					P = lngamma((double)NN, info) - lngamma((double)MM, info) + 
					    lngamma((double)KK, info) + lngamma((double)(MM-NN), info) - 
						lngamma((double)LL, info) - lngamma((double)(NN-LL), info) - 
					    lngamma((double)(KK-LL), info) - lngamma((double)(MM-NN-KK+LL), info) + 
						lngamma((double)(MM-KK), info);
				P = P + Math.log(SCALE);
				if(P < ELIMIT) 
				{
					IFAULT = 3;
					if( (double)(LL) > (double)(NN*KK + NN + KK + 1) / (double)(MM + 2) ) CHYPER = ONE;
					return CHYPER;
				}
				else
				{
	...
	//           SCALE UP AT THIS POINT.
	        ...
	        if(L <= KL) 
			{
				for(I=1; I<=L-1; I++)
				{
					P = P * (double)(L-I) * (double)(MNKL-I) /
	                        ( (double)(NL+I) * (double)(KL+I) );
					PT = PT + P;
				}
				if(P == ZERO) IFAULT = 3;
			}
	...
	public double hypergeo_cdf( int x, int n, int M, int N, int info )
	{
	/* 
